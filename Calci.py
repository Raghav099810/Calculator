...
class Calci:
    def __init__(self, master):
        ...
        self.entry_value = ''
        Entry(width=17, bg="#1E900F", font=('Arial Bold',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11, height=4, text='C',relief='flat',bg='blue',command=self.clear).place(x=270,y=350)
        Button(width=11, height=4, text='=',relief='flat',bg = 'red',command=self.solve).place(x=0,y=350)
